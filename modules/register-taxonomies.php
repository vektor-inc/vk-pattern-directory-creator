            ...
            <table class="table form-table">
                ...
                <tbody>
                    <?php foreach ( $taxonomies as $index => $taxonomy ) : ?>
                        <tr>
                            <td>
                                <input type="text" name="taxonomies[<?php echo $index; ?>][name]" value="<?php echo esc_attr( $taxonomy['name'] ); ?>" placeholder="<?php __( 'Category', 'vk-pattern-directory-creator' ); ?>" />
                            </td>
                            <td>
                                <input type="text" name="taxonomies[<?php echo $index; ?>][slug]" value="<?php echo esc_attr( $taxonomy['slug'] ); ?>" placeholder="<?php __( 'category', 'vk-pattern-directory-creator' ); ?>" />
                            </td>
                            <td>
                                <input type="checkbox" name="taxonomies[<?php echo $index; ?>][hierarchical]" <?php checked( $taxonomy['hierarchical'], false ); ?> />
                            </td>
                            <td>
                                <input type="submit" name="remove_taxonomy[<?php echo $index; ?>]" class="button remove-taxonomy" value="<?php __( 'Remove', 'vk-pattern-directory-creator' ); ?>" />
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                <tfoot>
                    <tr>
                        <td><p class="description"><?php __( 'Use only lowercase letters, numbers, hyphens, and underscores.', 'vk-pattern-directory-creator' ); ?></p></td>
                        <td><p class="description"><?php __( 'The URL-friendly version of the name (e.g., category)', 'vk-pattern-directory-creator' ); ?></p></td>
                        <td><p class="description"><?php __( 'Make it a tag (do not hierarchize)', 'vk-pattern-directory-creator' ); ?></p></td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
            <p><a href="#" id="add-taxonomy" class="button"><?php __( 'Add Taxonomy', 'vk-pattern-directory-creator' ); ?></a></p>
            <p><input type="submit" name="save_custom_taxonomies" class="button-primary" value="<?php __( 'Save Taxonomies', 'vk-pattern-directory-creator' ); ?>" /></p>
        </form>
    </div>
    <style>
        .form-table {
