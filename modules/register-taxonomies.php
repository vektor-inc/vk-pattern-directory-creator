        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('add-taxonomy').addEventListener('click', function(e) {
                ...
                row.innerHTML = '<td>' +
                    ...
                    '</td>' +
                    '<td style="width: 10%;/* 仮 */"><input type="submit" name="remove_taxonomy[' + index + ']" class="button remove-taxonomy" value="<?php _e( 'Remove', 'vk-pattern-directory-creator' ); ?>" disabled /></td>';
